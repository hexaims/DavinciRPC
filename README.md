...
- You can enable or disable DavinciRPC by opening the hidden icons in the Windows taskbar, just click the little arrow (^) and find the DavinciRPC icon.
...
I know DavinciRPC is currently getting false flagged as a virus by some antivirus, and I am working into fixing it.
